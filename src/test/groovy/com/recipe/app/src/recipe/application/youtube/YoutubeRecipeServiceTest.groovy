...
class YoutubeRecipeServiceTest extends Specification {
    ...
    def "유튜브 레시피 검색 - 스크랩순"() {
        ...
        youtubeRecipeRepository.countByKeyword(_ as String) >> 20
        ...
        youtubeRecipeRepository.findByKeywordLimitOrderByYoutubeScrapCntDesc(_ as String, lastYoutubeRecipeId, 0, size) >> youtubeRecipes
    ...
    def "유튜브 레시피 검색 - 조회순"() {
        ...
        youtubeRecipeRepository.findByKeywordLimitOrderByYoutubeViewCntDesc(_ as String, lastYoutubeRecipeId, 0, size) >> youtubeRecipes
    ...
    def "유튜브 레시피 검색 - 최신순"() {
        ...
        youtubeRecipeRepository.findByKeywordLimitOrderByPostDateDesc(_ as String, lastYoutubeRecipeId, null, size) >> youtubeRecipes
