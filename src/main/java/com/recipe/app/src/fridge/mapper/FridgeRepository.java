...
public interface FridgeRepository extends CrudRepository<Fridge, Integer> {
    List<Fridge> findAllByUserAndStatus(UserEntity user, String status);

    List<Fridge> findAllByUserAndStatusAndIngredientNameIn(UserEntity user, String active, List<String> ingredientName);
